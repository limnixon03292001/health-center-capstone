  ...
  return (
    <div className="lg:px-8">
      ...
      <div className="mb-6 text-left">
        <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm sm:w-auto px-5 py-2.5 text-center rounded-full">Login</button>
      </div>
