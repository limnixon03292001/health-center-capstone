...
import SelectGender from '../../SelectBtn/SelectGender';
import SelectStatus from '../../SelectBtn/SelectStatus';
...
const Signup = ({ setisSwitch, setData ,data }) => {
    ...
    <div className='w-full h-full py-2'>
        ...
        <div>
            <div className="relative z-0 w-full mb-6 group">
                <input type="email" name="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required onChange={(e) => setData(e.target.value)} value={data} />
